		...
		<main className='bg-white font-serif space-y-[100px]'>
			<section
				...
				<div className='w-full max-w-[700px] space-y-[13px]'>
					...
					<p className='text-[12px] text-[#E5E5E5] max-w-[400px]'>
			...
			<section
				...
				<p className='text-[14px] text-[#495057] pb-5'>
					...
					Seamlessly negotiate ubiquitous leadership skills rather
					than parallel ideas. Dramatically visualize superior
					interfaces for best-of-breed alignments. Synergistically
					formulate performance based users through customized
					relationships. Interactively deliver cross-platform ROI via
					granular systems. Intrinsicly enhance effective initiatives
					vis-a-vis orthogonal outsourcing. Rapidiously monetize
					market-driven opportunities with multifunctional users.
					Collaboratively enhance visionary opportunities through
					revolutionary schemas. Progressively network just in time
			...
			<footer className='bg-[#212529] h-[30vh] w-full'></footer>
		</main>
	)
}
